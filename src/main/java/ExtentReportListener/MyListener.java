...
public class MyListener extends TestBase implements ITestListener {
 ...
 public void onTestFailure(ITestResult result) {
  ...
  try {
	  ...
	  FileUtils.copyFile(src, new File("C:\\prashant\\BookingTickets\\MakeMyTrip\\" + result.getMethod().getMethodName() + ".png"));
	  String file = test.addScreenCapture("C:\\prashant\\BookingTickets\\MakeMyTrip\\" + result.getMethod().getMethodName() + ".png");   	  
